-- =============================================================
-- 07_rbac.sql
-- SELFHEALING_PIPELINE role — read-only on SELFHEALING_PROD,
...
CREATE ROLE IF NOT EXISTS SELFHEALING_PIPELINE;
...
GRANT ROLE SELFHEALING_PIPELINE TO ROLE ACCOUNTADMIN;
